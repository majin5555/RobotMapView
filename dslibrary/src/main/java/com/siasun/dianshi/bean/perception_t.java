 ...
 * 感知模块结构体
 */
public final class perception_t implements LCMEncodable {
    ...
    public static long _hashRecursive(ArrayList<Class<?>> classes) {
        if (classes.contains(perception_t.class))
            return 0L;

        classes.add(perception_t.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException {
        ...
        __strbuf = new char[this.name.length()];
        this.name.getChars(0, this.name.length(), __strbuf, 0);
    ...
    public perception_t(byte[] data) throws IOException {
        this(new LCMDataInputStream(data));
    }

    public perception_t(DataInput ins) throws IOException {
    ...
    public static perception_t _decodeRecursiveFactory(DataInput ins) throws IOException {
        perception_t o = new perception_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException {
        ...
        ins.readByte();
        this.name = new String(__strbuf);

        this.enabled = ins.readByte() != 0;

    }

    public perception_t copy() {
        perception_t outobj = new perception_t();
