...
//        Point2d start = GetStartPnt();
//        Point2d end = GetEndPnt();
//        PointF startScreen = ScrnRef.worldToScreen(start.x, start.y);
//        PointF endScreen = ScrnRef.worldToScreen(end.x, end.y);
//        float centerX = (startScreen.x + endScreen.x) / 2;
//        float centerY = (startScreen.y + endScreen.y) / 2;
//
//        String idStr = String.valueOf(m_uId);
//        paint.setColor(Color.BLUE);
//        Grp.drawText(idStr, centerX + 4 * ScrnRef.scale, centerY + 14 * ScrnRef.scale, paint);
//    }
//
//
//}
