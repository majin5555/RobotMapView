...
//     * 处理全局路径规划
//     */
//    private fun handleGlobalPathPlan(
//        result: PlanPathResult,
//        pathPlanResultBean: PathPlanResultBean
//    ) {
...
//     * 处理清扫路径规划
//     */
//    private fun handleCleanPathPlan(
//        result: PlanPathResult,
//        pathPlanResultBean: PathPlanResultBean
//    ) {
//        // 清扫路径规划 - 接收PP返回pad结果
...
//     * 处理示教路线规划
//     */
//    private fun handleTeachPathPlan(
//        result: PlanPathResult,
//        pathPlanResultBean: PathPlanResultBean,
//        mMapView: MapView?
//    ) {
...
//        mMapView?.createContinuousPathTeach(pathSegments, 2, uExtType)//单项双向
//        // 回收所有Point2d对象
...
//        val maxSegments =
//            if (isGlobalPath) result.m_iPathSum else minOf(result.m_iPathSum, MAX_PATH_SEGMENTS)
//
//        // 检查数据点数量是否足够
